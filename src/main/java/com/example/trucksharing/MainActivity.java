            ...
            public void onClick(View view) {
                ...
                if(cursor.moveToFirst()){
                    ...
                    if(password.equals(edit_text_pass_word.getText().toString())){
                        ...
                        Toast.makeText(MainActivity.this,"password wrong, please try again",Toast.LENGTH_SHORT).show();
                        return;
                    }
                }else{
                    Toast.makeText(MainActivity.this,"user not exist,please sign up",Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        });
